...
Чудесного погружения в новое изобильное восприятие, дорогие! ❤️❤️❤️''', parse_mode='markdown')
...
Позвольте себе быть счастливой — сегодня, сейчас, отныне и навсегда! ❤️‍🔥''', parse_mode='markdown')
    ...
    await bot.send_audio(user_id,
                         '''CQACAgIAAxkBAAPRZ6XWuOGbXFMDrCZ9g6t-2DI3rUgAAls9AALkQllKhaG50Z6xzQs2BA''', caption='''ПРОЦЕСС-ПРОРАБОТКА ЖЕНСКИЙ РОД
...
Успешного погружения и красивых трансформаций!''')
...
🫂Дорогие, напоминаю о важности заботы о своем теле. Тело- наш храм. Чтобы интегрировать полученную информацию, 
энергию, необходимо быть в контакте с телом, и системно давать ему любовь и заботу в виде физической активности и 
расслабляющих водных процедур.''', parse_mode='markdown')
    await bot.send_video(user_id,
